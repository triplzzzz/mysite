...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <title>История_аренды</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="История_аренды.css" media="screen">
    <script src="time.js"></script>
    <script src="istor_sam.js"></script>
    ...
    <meta property="og:title" content="История_аренды">
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-align-center u-grey-75 u-table-header u-table-header-1">
              <tr style="height: 25px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">Номер самоката</th>
